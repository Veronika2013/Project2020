...
void MainWindow::save(const QString &s) { //Slot for saving passwords(button slot)
  ...
  (QIODevice::WriteOnly  | QIODevice::Append);
      if(fileWithPass->size()== 0){
         ...
         QString dataShare = bakFileWithPass->readAll();
         fileWithPass->write(dataShare.toUtf8());//Bug
...
void MainWindow::info_about_bak()
{
  ...
  QMessageBox::information(this, ("My passwords"), ("Backup-file exist and not empty. If you remove passwoords, you can return his"));
...
void MainWindow::backup_data_real()
{
  ...
  bakFile->copy("libgcc7_snt.dll","lib_ptr.dll" );
...
{
  QDesktopServices::openUrl(QUrl("https://b24-8dd5ja.bitrix24.site/"));//Insert site support
}
